...
int main() {
  unordered_map<int, string> my_map{
      ...
      cout << "Map has " << my_map.size() << " entries\n";

      if (my_map.find(960) == my_map.end()){
          cout << "Key 960 not found in map\n";
          my_map[960] = "Maldives";
          cout << "Key 960 added to map\n";
      }


      vector<int> known_codes {1, 31, 91, 960};

      for (int country_code: known_codes){
          cout << country_code << ": " << my_map[country_code] << "\n";
      }
